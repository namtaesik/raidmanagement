...
export default function UserInfoManagement() {
  const loginUserId = store.getState().loginUser.loginUserId;
  ...
  const onProfileImageSave = () => {
    ...
    alert("현재 서버의 용량이 적어 프로필 사진은 '태신'이 직접 등록해드리고 있습니다.\r\n오픈톡에서 '태신'을 호출해주세요.");
    ...
    <Container maxWidth="sm" sx={{ maxWidth: "800px", justifyContent: "center", marginBottom: "100px", paddingLeft: "2px", paddingRight: "2px" }}>
      <List>
        ...
        <ListItem>
          ...
          <Button sx={{ marginLeft: "auto" }} onClick={onProfileImageSave} variant="contained">
            저장
          </Button>
        </ListItem>
      </List>
